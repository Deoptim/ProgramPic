...
*
* Change log:
* 04/15/22:  - added support "configuration word 2" programm/erase, added support for PIC12(L)F1822/PIC16(L)F1823. Bump version to 1.9
...
struct deviceInfo const devices[] PROGMEM = {
    ...
    {s_pic12f683, 0x0460, 2048, 0x2000, 0x2100, 8, 256, 0, 0, FLASH4, EEPROM, MCLR_first},
    ...
    {s_pic16f635, 0x0FA0, 1024, 0x2000, 0x2100, 9, 128, 0, 0, FLASH4, EEPROM, MCLR_first},
    {s_pic16f636, 0x10A0, 2048, 0x2000, 0x2100, 9, 256, 0, 0, FLASH4, EEPROM, MCLR_first},
